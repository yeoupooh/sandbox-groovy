// http://www.sindhud.info/2009/11/18/groovy-jfreechart.html
...
def plot(symbols) {
    def series = symbols.collect { symbol ->    // for each symbol create a series
        ...
        //def url = "http://ichart.yahoo.com/table.csv?s=BAS.DE&a=0&b=1&c=2000%20&d=0&e=31&f=2010&g=w&ignore=.csv"
